function res = Evaluate(oriResPath, DataSet, w_occ, maxDist)
    ...
    switch DataSet
        case 'PIOD'
            % '/home/xuli/researchfiler/occdata/PIOD/Data'
            oriGtPath = '/home/xuli/researchfiler/occdata/PIOD/Data';
            testIdsFilename = '/home/xuli/researchfiler/occdata/PIOD/val_doc_2010.txt';

            opt.method_folder = 'TPENet';
            opt.model_name = 'PIOD';
            
        case 'BSDSownership'
            oriGtPath = '/home/xuli/researchfiler/occdata/BSDSownership/testfg/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/BSDSownership/Augmentation/test_ori_iids.lst';

            opt.method_folder = 'TPENet';
            opt.model_name = 'BSDSownership';

        case 'nyuv2_ocpp'
            oriGtPath = '/home/xuli/researchfiler/occdata/NYUv2-OCpp/ob/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/NYUv2-OCpp/test.txt';
        ...
        case 'synocc_test'
            % full test set, but time cost......
            oriGtPath = '/home/xuli/researchfiler/occdata/synocc/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/synocc_split/synocc_test200.txt';            
        ...
        case 'synocc_val'
            ...
            % one way to resize is after reading gt, another way is after edge nms
            oriGtPath = '/home/xuli/researchfiler/occdata/synocc/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/synocc_split/synocc_fval.txt';

            opt.method_folder = 'TPENet';
            opt.model_name = 'syn-occ1080f-val';            
            
        case 'diode'
            oriGtPath = '/home/xuli/researchfiler/occdata/DIODE/gt/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/DIODE/diode_val50.txt';

            opt.method_folder = 'TPENet';
            opt.model_name = 'ByDIODE';       
            
        case 'entityseg'
            oriGtPath = '/home/xuli/researchfiler/occdata/EntitySeg/gt/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/EntitySeg/entityseg_val70.txt';
            opt.method_folder = 'TPENet';
            opt.model_name = 'ByEntitySeg';        
            
        case 'cmu'
            oriGtPath = '/home/xuli/researchfiler/occdata/CMU/gt/';
            testIdsFilename = '/home/xuli/researchfiler/occdata/CMU/cmu_val30.txt';
            opt.method_folder = 'TPENet';
            opt.model_name = 'CMU';   
    end
